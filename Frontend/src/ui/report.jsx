...
import ShinyText from "../ui/components/shineText";
  ...
  return (
    <div className="min-h-screen flex flex-col relative bg-[#0a0a0a] text-white font-sans">
      ...
      <header className="pt-2 h-[10vh] w-screen flex  text-white justify-between">
        ...
        <button className="cursor-pointer mr-20 mt-4 mb-3 font-semibold px-6 active:scale-95 hover:bg-white/75 bg-white text-black font-[font1] rounded-xl">Logout</button>
      </header>
              ...
              <div className="space-y-6">
                <div className="border border-white/10 bg-white/5 rounded-xl p-5 transition-all hover:border-white/20">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span className="px-2.5 py-1 text-xs font-medium rounded-full bg-blue-900/30 text-blue-300 border border-blue-800/50">Frontend</span>
                  </div>
                  <p className="text-sm text-gray-300 leading-relaxed mb-4">
                    How does it compare to the actual DOM, and why does it make React faster? Provide a simple example of how a state change updates the DOM.
                  </p>
                  
                  <div className="mb-4">
                    <span className="inline-block px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded bg-purple-900/30 text-purple-300 mb-2">Intention</span>
                    <p className="text-sm text-gray-400 italic">To assess the candidate's understanding of React's rendering optimization and reconciliation process.</p>
                  </div>
                  
                  <div className="mb-4">
                    <span className="inline-block px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded bg-green-900/30 text-green-300 mb-2">Model Answer</span>
                    <p className="text-sm text-gray-300">The Virtual DOM is a lightweight JavaScript representation of the actual DOM. When state changes, React creates a new Virtual DOM tree, compares it with the previous one (diffing), and calculates the minimum number of changes needed to update the real DOM (reconciliation). This avoids expensive direct DOM manipulations.</p>
                  </div>
                ...
                <div className="border border-white/10 bg-white/5 rounded-xl p-5 transition-all hover:border-white/20">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span className="px-2.5 py-1 text-xs font-medium rounded-full bg-yellow-900/30 text-yellow-300 border border-yellow-800/50">Core JS</span>
                  </div>
                  <p className="text-sm text-gray-300 leading-relaxed mb-4">
                  ...
                  <div className="mb-4">
                    <span className="inline-block px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded bg-purple-900/30 text-purple-300 mb-2">Intention</span>
                    <p className="text-sm text-gray-400 italic">To evaluate knowledge of JavaScript's scope chain and memory management through persistent variable access.</p>
                  </div>
                  
                  <div className="mb-4">
                    <span className="inline-block px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded bg-green-900/30 text-green-300 mb-2">Model Answer</span>
                    <p className="text-sm text-gray-300">A closure is the combination of a function bundled together with references to its surrounding state (the lexical environment). It allows an inner function to access the scope of an outer function even after the outer function has finished executing. Practical uses include data privacy (private variables) and function factories.</p>
                  </div>
                ...
                <div className="border border-white/10 bg-white/5 rounded-xl p-5 transition-all hover:border-white/20">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span className="px-2.5 py-1 text-xs font-medium rounded-full bg-purple-900/30 text-purple-300 border border-purple-800/50">Backend</span>
                  </div>
                  <p className="text-sm text-gray-300 leading-relaxed mb-4">
                  ...
                  <div className="mb-4">
                    <span className="inline-block px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded bg-purple-900/30 text-purple-300 mb-2">Intention</span>
                    <p className="text-sm text-gray-400 italic">To verify understanding of standard web architecture and communication protocols between client and server.</p>
                  </div>
                  
                  <div className="mb-4">
                    <span className="inline-block px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded bg-green-900/30 text-green-300 mb-2">Model Answer</span>
                    <p className="text-sm text-gray-300">REST (Representational State Transfer) relies on stateless communication and standard HTTP methods: GET (Read), POST (Create), PUT/PATCH (Update), and DELETE (Remove). Statelessness means each request from a client must contain all the information necessary to understand and complete the request, without relying on stored context on the server.</p>
                  </div>
              ...
              <div className="space-y-6">
                <div className="border border-white/10 bg-white/5 rounded-xl p-5 transition-all hover:border-white/20">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span className="px-2.5 py-1 text-xs font-medium rounded-full bg-blue-900/30 text-blue-300 border border-blue-800/50">Teamwork</span>
                  </div>
                  
                  <div className="mb-4">
                    <span className="inline-block px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded bg-purple-900/30 text-purple-300 mb-2">Intention</span>
                    <p className="text-sm text-gray-400 italic">To assess your conflict resolution skills, emotional intelligence, and ability to collaborate professionally under stress.</p>
                  </div>
                  
                  <div className="mb-4">
                    <span className="inline-block px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded bg-green-900/30 text-green-300 mb-2">Model Answer</span>
                    <p className="text-sm text-gray-300">Use the STAR method (Situation, Task, Action, Result). Focus on resolving the issue professionally rather than assigning blame. Highlight your ability to listen to the other person's perspective, find common ground, and achieve a positive outcome that benefited the project.</p>
                  </div>
                </div>
                ...
                <div className="border border-white/10 bg-white/5 rounded-xl p-5 transition-all hover:border-white/20">
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span className="px-2.5 py-1 text-xs font-medium rounded-full bg-yellow-900/30 text-yellow-300 border border-yellow-800/50">Problem Solving</span>
                  </div>
                  
                  <div className="mb-4">
                    <span className="inline-block px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded bg-purple-900/30 text-purple-300 mb-2">Intention</span>
                    <p className="text-sm text-gray-400 italic">To evaluate your problem-solving methodology, perseverance, and how you approach debugging or learning new concepts.</p>
                  </div>
                  
                  <div className="mb-4">
                    <span className="inline-block px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded bg-green-900/30 text-green-300 mb-2">Model Answer</span>
                    <p className="text-sm text-gray-300">Choose a specific, non-trivial problem. Explain the steps you took to isolate the root cause, the resources you consulted (documentation, colleagues), and the rationale behind your chosen solution. Discuss what you learned from the experience.</p>
                  </div>
                </div>
              </div>
            </div>
